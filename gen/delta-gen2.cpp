...
int main(int argc, char* argv[]){
	if(argc < 9 || argc > 11){
		cerr << "Generate delta information. Optimized for large graphs. Note: result of same input graph and seed but different #parts are NOT guaranteed to be identical.\n"
