...
std::vector<Jacobi::MyOperation::DummyNode> Jacobi::MyOperation::dummy_nodes()
{
	DummyNode res;
	neighbor_list_t onb;
...
Jacobi::value_t Jacobi::MyOperation::func(const node_t& n, const neighbor_t& neighbor)
{
...
// <constant> 
AppArguments Jacobi::MySeparator::separate(const std::vector<std::string>& args) {
    AppArguments res;
